package de.kallifabio.shoppinglist.java_files;
...
public class SaveDataBackground extends AsyncTask<String, Void, String> {

    Context context;
    AlertDialog alertDialog;

    public SaveDataBackground(Context ctx) {
        context = ctx;
    }
